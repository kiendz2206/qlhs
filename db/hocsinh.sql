...
INSERT INTO `diemthi` (`diemthiID`, `hocsinhID`, `toan`, `ly`, `hoa`, `anh`) VALUES
(1, 6, 8, 8.5, 8, 8),
(2, 2, 10, 9, 8, 5),
(3, 12, 8, 7, 8, 7),
(4, 11, 9, 8, 8, 8),
...
INSERT INTO `giaovien` (`idGiaovien`, `masoGV`, `hoten`, `trinhdo`, `chuyenmon`, `email`, `sdt`, `link_avt_GV`) VALUES
...
INSERT INTO `hocsinh` (`hocsinhID`, `MaHS`, `lopID`, `name`, `birthday`, `phonenumber`, `address`, `avt`, `so_truong`) VALUES
...
--
ALTER TABLE `diemthi`
  ADD PRIMARY KEY (`diemthiID`,`hocsinhID`),
...
--
ALTER TABLE `giaovien`
  MODIFY `idGiaovien` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `hocsinh`
  MODIFY `hocsinhID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `diemthi`
  ADD CONSTRAINT `diemthi_ibfk_1` FOREIGN KEY (`hocsinhID`) REFERENCES `hocsinh` (`hocsinhID`);

--
-- Constraints for table `hocsinh`
--
ALTER TABLE `hocsinh`
  ADD CONSTRAINT `hocsinh_ibfk_1` FOREIGN KEY (`lopID`) REFERENCES `lophoc` (`lopID`);
COMMIT;
